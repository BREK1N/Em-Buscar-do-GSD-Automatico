...
urlpatterns = [
    ...
    path('patd/trash/', views.PATDTrashView.as_view(), name='patd_trash'),
    path('patd/<int:pk>/restore/', views.patd_restore, name='patd_restore'),
    path('patd/<int:pk>/permanently_delete/', views.patd_permanently_delete, name='patd_permanently_delete'),
    path('patd/trash/esvaziar/', views.lixeira_esvaziar, name='lixeira_esvaziar'),
    path('patd/trash/config/', views.lixeira_config, name='lixeira_config'),
